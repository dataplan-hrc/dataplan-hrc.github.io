...
(:constants
    ...
    pan_1 pan_2 metal_pot office_bag - mobileR

    glass_1 plate_1 bowl_1 glass_2 plate_2 bowl_2 plate_3 plate_4 plate_5 - fragile_receptacle
)
...
(:predicates
 ...
 (cleaned ?o - obj)
 (sliced ?o - obj)
 (cooked ?o - obj) ;changed
 (prepared ?o - obj)
 (baked ?o - tobake)
 (salad_prepared ?r - mobileR ?o1 ?o2 ?o3 - obj)
 (pizza_baked)
 (pizza_base_prepared)
 (boiled ?o2 - obj) ;changed
 (roasted ?o - obj) ;changed
 (egg_prepared ?o - obj) ;changed
 ...
 (salad ?o - obj)
 (charged ?o - obj)
 (provided_at ?o - obj ?r - immobileR ?l - location)
 (party_at ?l - location)
...
(:action Agent_PutsDown_Receptacle 
 ...
 :effect (and(not(InAgentHand ?r1))
             (not(agent_hands_occupied_wr))
             (when 
                 (and(is_fragile ?r1)(not(agent_near stove_burner_1 kitchen))(not(agent_near stove_burner_2 kitchen))(not(agent_near stove_burner_3 kitchen))(not(agent_near stove_burner_4 kitchen)))
                 (receptacle_at ?r1 ?r2 ?l))
             
             (when(not_fragile ?r1)(receptacle_at ?r1 ?r2 ?l))
             (increase (total-cost) 10))
...
(:action Make_Fruit_Salad
 :parameters (?r - mobileR ?o1 ?o2 ?o3 ?o4 - fruit)
 :precondition(and(not(agent_hands_occupied_wo))
                  (not(agent_hands_occupied_wr))
                  (not(heavy_obj_in_agent_hand))
                  (sliced ?o1)(sliced ?o2)(sliced ?o3)
                  (agent_near countertop kitchen)
                  (item_in ?o1 bowl_1 countertop kitchen)
                  (item_in ?o2 bowl_1 countertop kitchen)
                  (item_in ?o3 bowl_1 countertop kitchen)
                  (salad ?o4)
                  (not(salad_prepared bowl_1 ?o1 ?o2 ?o3))
                  (not(prepared ?o4))
              )
 :effect(and
             (when(and(not(InAgenthand plate_1))
                      ...
                      (not(InAgenthand bowl_1))
                      (not(InAgenthand bowl_2)))
                      (salad_prepared bowl_1 ?o1 ?o2 ?o3))
            (prepared ?o4)
...
(:action agent_serves_Drink 
 :parameters (?o - drink ?r1 - fragile_receptacle ?r2 - immobileR ?l - location)
 :precondition(and
                  (agent_near ?r2 ?l)
                  (receptacle_at ?r1 ?r2 ?l)
                  (not(heavy_obj_in_agent_hand))
...
(:action agent_passes_to_human
 ...
 :precondition(and
                  (agent_near ?r ?l)
                  (human_near ?r ?l)
                  (or(In_agent_handB ?o)(In_agent_hand ?o))
                  (not(heavy_obj_in_human_hand))
                  (not(human_hands_occupied_wo))
                  (not(human_hands_occupied_wr))
 ...
 :effect(and(In_human_hands ?o ?l)
            (not(In_agent_handB ?o))
            (when(and(In_agent_handB ?o)
                 (not(In_agent_hand ?o)))
                 (In_human_handB ?o))
            (when(and(In_agent_hand ?o)
                 (not(In_agent_handB ?o)))
                 (In_human_hand ?o))
            (heavy_obj_in_human_hand)
            (increase (total-cost) 5)
...
(:action agent_provides_
 :parameters(?o - obj ?r - immobileR ?l - location)
 :precondition(and(agent_near ?r ?l)
                  (human_near ?r ?l)
                  (In_agent_hand ?o)
                  (not(provided_at ?o ?r ?l))          
 )
 :effect(and(provided_at ?o ?r ?l)(increase (total-cost) 5))
)
